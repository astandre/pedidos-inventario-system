...
urlpatterns = [
    ...
    path(r'api/pedido/<int:id_pedido>', views.pedido_api, name='pedido_api'),
    path(r'api/pedido/estado/<int:id_pedido>/<str:estado>', views.pedido_status_api, name='pedido_status_api'),
